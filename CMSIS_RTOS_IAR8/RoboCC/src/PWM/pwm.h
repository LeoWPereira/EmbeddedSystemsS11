...
#define REGISTER_H_BRIDGE_MOTOR_1_1       LPC_IOCON->PIO1_4
#define REGISTER_H_BRIDGE_MOTOR_1_2       LPC_IOCON->PIO1_5
#define REGISTER_H_BRIDGE_MOTOR_2_1       LPC_IOCON->PIO2_7
#define REGISTER_H_BRIDGE_MOTOR_2_2       LPC_IOCON->PIO2_9
